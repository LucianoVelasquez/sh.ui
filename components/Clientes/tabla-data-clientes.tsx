...
/* import AddProducto from "../ControlStock/addprodcuto"
 */import AddProducto from '@/components/ControlStock/addprodcuto'
import LoadingSpin from "@/components/Loading/loading"
import AddButtonCliente from "@/components/Clientes/addcliente"
...
export function TablaDataClientes<TData, TValue>({
  columns,
  data
  ...
  return (
    <div className="flex flex-col justify-center items-center">
       ...
       <div className="relative flex justify-center items-center bg-background gap-2 bg- h-24 w-11/12 rounded-md shadow-md mt-4">
          ...
          }  type="search" placeholder="Buscar cliente" className="border-stone-950 dark:border-white w-full max-w-xs"></Input>
          <AddButtonCliente></AddButtonCliente>
      </div>
